...
void ddr_init(void)
{
    ...
    reg32_write(0x3d400000, 0x3040001);
    reg32_write(0x3d400030, 0x0);
    reg32_write(0x3d400034, 0x402010);
    reg32_write(0x3d400050, 0x210000);
    reg32_write(0x3d400054, 0x0);
    reg32_write(0x3d400060, 0x0);
    reg32_write(0x3d400064, 0x62008c);
    reg32_write(0x3d4000d0, 0x2004e);
    reg32_write(0x3d4000d4, 0x0);
    reg32_write(0x3d4000dc, 0x510);
    reg32_write(0x3d4000e0, 0x0);
    reg32_write(0x3d4000e4, 0x100004);
    reg32_write(0x3d4000e8, 0x0);
    reg32_write(0x3d4000ec, 0x0);
    reg32_write(0x3d4000f0, 0x0);
    reg32_write(0x3d4000f4, 0x66f);
    reg32_write(0x3d400100, 0xf101b0f);
    reg32_write(0x3d400104, 0x80414);
    reg32_write(0x3d400108, 0x305060d);
    reg32_write(0x3d40010c, 0x50400c);
    reg32_write(0x3d400110, 0x5040405);
    reg32_write(0x3d400114, 0x5050403);
    reg32_write(0x3d40011c, 0x202);
    reg32_write(0x3d400120, 0x3034405);
    reg32_write(0x3d400124, 0x4040d);
    reg32_write(0x3d40012c, 0x440c021c);
    reg32_write(0x3d400130, 0x20610);
    reg32_write(0x3d40013c, 0x0);
    reg32_write(0x3d400180, 0x2000040);
    reg32_write(0x3d400184, 0x2000100);
    reg32_write(0x3d400190, 0x7020002);
    reg32_write(0x3d400194, 0x404);
    reg32_write(0x3d400198, 0x7000000);
    reg32_write(0x3d40019c, 0x0);
    reg32_write(0x3d4001a0, 0x400003);
    reg32_write(0x3d4001a4, 0x10001);
    reg32_write(0x3d4001a8, 0x80000000);
    reg32_write(0x3d4001b0, 0x1);
    reg32_write(0x3d4001b4, 0x202);
    reg32_write(0x3d4001b8, 0x0);
    reg32_write(0x3d4001c0, 0x1);
    reg32_write(0x3d400200, 0x0);
    reg32_write(0x3d400204, 0x0);
    reg32_write(0x3d400208, 0x0);
    reg32_write(0x3d40020c, 0x0);
    reg32_write(0x3d400210, 0x0);
    reg32_write(0x3d400214, 0x0);
    reg32_write(0x3d400218, 0x0);
    reg32_write(0x3d40021c, 0x0);
    reg32_write(0x3d400220, 0x0);
    reg32_write(0x3d400240, 0x4000400);
    reg32_write(0x3d400244, 0x2211);
